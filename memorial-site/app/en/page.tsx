...
export default function EnglishHome(){
  return <main className="memory-home" lang="en">
    ...
    <section className="memory-invitation closing-invitation" id="memories"><h2>There is a place here for your memories, too.</h2><p>A photograph is welcome, but never needed.</p><a className="memory-button" href="/en/contribute">Share a Memory →</a></section><footer><span>In Loving Memory of Professor Young Hoon Jung</span><span><Link href="/">한국어</Link> · English</span></footer><MobileNav language="en" />
  </main>;
}
