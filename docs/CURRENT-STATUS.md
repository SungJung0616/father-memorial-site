...
- 생애 연보와 가족 확인 약력
- 가르침과 연구의 흐름, 교신저자 기록을 확인한 선별 논문 5편, 공동발명자로 확인되는 등록 특허 3건. 기존 논문 원자료 12편 중 미확인 7편은 공개 목록에서 보류하며 원자료를 보존한다. 공동저자 이름은 삭제하지 않는다. 선별 기준과 출처는 `18-RESEARCH-RECORD-REVIEW.md`에 기록했다. 대학의 전체 공저 목록을 자동으로 가져오지 않는다.
- 공개 추억 사진첩
